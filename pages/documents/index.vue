<template>
    <div class="w-full h-full sm:h-[95%] overflow-hidden mb-2">
        <Toolbar />
     <!-- Container -->
        <section class="overflow-hidden bg-transparent w-full h-[80%] sm:h-[90%] mt-[20%] sm:mt-0 grid grid-cols-12 gap-y-2 gap-x-4 pt-2 px-2 sm:px-4">

            <!-- Table Container -->
            <div v-if="docs"  class="h-full p-4 rounded-2xl bg-white dark:bg-[#12171d] overflow-y-scroll col-span-12" >
