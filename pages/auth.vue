<template>
  <div class="w-full h-full overflow-y-scroll bg-[#f6f6f6] dark:bg-[#0b1015]">
    ...
    <section class="w-full h-full flex flex-row items-center justify-center ">
        ...
        <div v-if="signup" class="w-full sm:w-[60%] lg:w-[40%] space-y-8 sm:space-y-12">

          <div class="w-full flex flex-col items-center justify-center space-y-5">
            <h1 class="text-5xl text-white font-bold" data-aos="fade-right" data-aos-once="true">
              Sign Up
            </h1>
            <p class="text-xl text-[#555a5c] text-center flex flex-row items-center justify-center">
          ...
          <div class="w-full flex flex-col items-center justify-center space-y-8 px-12">
            ...
            <div class="w-full flex flex-col items-start justify-start space-y-6">
              ...
              <button class="w-full bg-[#555a5c] hover:bg-gray-500 flex flex-row items-center justify-center rounded-3xl p-3">
                <span class="text-[16px] text-black hover:text-gray-200 text-center">Create Account</span>
              </button>

              <span @click="signup = false" class="text-sm text-[#555a5c] text-left flex flex-row items-center justify-center cursor-pointer">Login <svg class="mx-2 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15"><path fill="none" stroke="white" d="m13.5 7.5l-4-4m4 4l-4 4m4-4H1"/></svg></span>
            </div>
          </div>
        ...
        <div v-else class="w-full sm:w-[60%] lg:w-[40%] space-y-8 sm:space-y-12">
          ...
          <div class="w-full flex flex-col items-center justify-center space-y-8 px-12">
            ...
            <div class="w-full flex flex-col items-start justify-start space-y-6">
              ...
              <span @click="signup = true" class="text-sm text-[#555a5c] text-left flex flex-row items-center justify-center cursor-pointer">Sign up <svg class="mx-2 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15"><path fill="none" stroke="white" d="m13.5 7.5l-4-4m4 4l-4 4m4-4H1"/></svg></span>
            </div>
          </div>
