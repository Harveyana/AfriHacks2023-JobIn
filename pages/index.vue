        ...
        <div class="h-full mb-[2rem] sm:mb-0 flex flex-col items-center justify-start overflow-hidden col-span-12 lg:col-span-9">
          ...
          <div  class="h-fit w-full flex flex-row items-center justify-between py-1 px-2 rounded-2xl mt-2">
            ...
            <DropdownMenuRoot v-model:open="toggleState" class="z-20">
              <DropdownMenuTrigger
                class="rounded-full z-20 w-[35px] h-fit inline-flex items-center justify-center text-grass11 bg-white shadow-[0_2px_10px] shadow-blackA7 outline-none hover:bg-green3 focus:shadow-[0_0_0_2px] focus:shadow-black"
                aria-label="Customise options"
              >
                <button  v-if="!showLoader" class=" lg:w-fit lg:h-fit p-1 sm:p-2 mx-1 bg-gray-400 dark:bg-white hover-bg-gray-200 dark:hover:bg-gray-400 flex items-center justify-center rounded-[50%]">
              ...
              <DropdownMenuPortal class="z-20">
                ...
                >
                  ...
                  <DropdownMenuArrow class="hidden sm:flex fill-white" />
                </DropdownMenuContent>
              </DropdownMenuPortal>
            </DropdownMenuRoot>
