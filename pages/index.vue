<template>
  <div class="w-full h-full z-10 overflow-y-scroll scroll-smooth bg-[#f6f6f6] dark:bg-[#0b1015]">
    <Toolbar />
    <!-- Container -->
    <section class="w-full h-[92%] my-[16%] sm:my-0 lg:mb-0 grid grid-cols-12 gap-y-2 gap-x-4 pt-2 px-2 sm:px-4 ">
        ...
        <div v-if="!showPreview" class="relative h-full mb-[2rem] sm:mb-0 flex flex-col items-center justify-start overflow-hidden col-span-12 lg:col-span-9">
          ...
          <div  class="h-fit w-full flex flex-row items-center justify-between py-1 px-2 rounded-2xl mt-2">
            ...
            <DropdownMenuRoot v-model:open="toggleState" class="z-20">
              ...
              >
                <button  v-if="!showLoader" class="flex-none border border-black w-12 h-full p-1 sm:px-4 mx-1 hover:bg-gray-600 dark:bg-white hover-bg-gray-200 dark:hover:bg-gray-400 flex items-center justify-center rounded-[50%]">
