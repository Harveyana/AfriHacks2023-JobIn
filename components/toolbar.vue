<template>
    <div class="relative sm:z-10 col-span-12 w-full h-fit max-h-[9%] bg-white dark:bg-[#0b1015] flex flex-row items-center justify-end px-3  py-2">
           <!-- hamburger icon for mobile only -->
            ...
            <img v-if="user" @click="toggle" :src="user.photoUrl" class="w-7 cursor-pointer p-1 rounded-[50px] bg-green-300 mx-3 md:my-1 md:w-8" />
