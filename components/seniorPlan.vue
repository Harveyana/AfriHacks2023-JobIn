<template>
            ...
            <div class="w-full p-5 sm:p-3 bg-white dark:bg-[#12171d] flex flex-col items-start justify-start rounded-2xl">
              <img
              ...
              <baseButton
              @click="pay()"
               class="border-2 hover:bg-black hover:text-white mt-3 border-black w-full px-6 py-3  bg-white text-black flex items-center justify-center"
              >
  ...
  const pay = ()=>{
    useFlutterwave({
      ...
      customizations: {description: "Payment for Senior Talent", logo: "https://firebasestorage.googleapis.com/v0/b/jobroute-58c44.appspot.com/o/JobRoutes%20logo%20SVG%201%20(2).png?alt=media&token=a668b178-01ac-40ba-ac16-41873c9b549d", title: "JobRoutes"},
      meta: {
