        ...
        <div class="w-full flex flex-col items-center justify-center space-y-8 px-12">
          ...
          <div class="w-full flex flex-col items-start justify-start space-y-6">
            ...
            <div class="w-full flex flex-col items-start ">
              ...
              <span @click="$router.push('/auth?tab=signUp')" class="text-lg text-[#555a5c] text-left flex flex-row items-center justify-center cursor-pointer mt-1 ml-4">Sign up <svg class="mx-2 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15"><path fill="none" stroke="white" d="m13.5 7.5l-4-4m4 4l-4 4m4-4H1"/></svg></span>
